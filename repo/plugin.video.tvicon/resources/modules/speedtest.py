...
class FTG_Speed_Test(animation):
	...
	def displayButtonRun(self, function="true"):
		if (function == "true"):
			...
			self.button_run = xbmcgui.ControlButton(button_run_glowx, button_run_glowy, 300, 122, "[B]Iniciar Speedtest[/B]",focusTexture=self.image_button_run,noFocusTexture=self.image_button_run, alignment=2 | 4,textColor='0xFF000000', focusedColor='0xFF000000',shadowColor='0xFFCCCCCC', disabledColor='0xFF000000')
	...
	def displayButtonClose(self, function="true"):
		if (function == "true"):
			...
			self.button_close = xbmcgui.ControlButton(99999, 99999, 300, 122, "[B]Sair[/B]",focusTexture=self.image_button_run,noFocusTexture=self.image_button_run, alignment=2 | 4,textColor='0xFF000000', focusedColor='0xFF000000',shadowColor='0xFFCCCCCC', disabledColor='0xFF000000')
	...
	units=('bit', 8), version=False):
		...
		startST.append('Testado para %(isp)s (%(ip)s)' % config['client'])
		self.update_textbox(startST)
